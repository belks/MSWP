...
Since WaveMeIn is not only meant simplify the unlock mechanism, but to raise the security, that will be an important task in the area oc computer science.
